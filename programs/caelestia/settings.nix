{
  ...
  launcher = {
    ...
    favouriteApps = [
      ...
      "steam"
      "affine"
      "Outer.Wilds--OuterWilds--1771244955.067084"
      "zen-twilight"
  ...
  services = {
    weatherLocation = "-22.6459,-47.1967";
    useFahrenheit = false;
  ...
  paths = {
    ...
    sessionGif = "~/Pictures/Wallpapers/terry-davis.gif";
    mediaGif = "~/Pictures/Wallpapers/lee-hardcastle.gif";
  };
}
