if vim.g.vscode then
	...
	if is_cursor then
		vim.keymap.set("n", "<leader>;a", function()
			vscode.action("composerMode.agent")
		end, { desc = "Cursor Toggle Chat" })
		vim.keymap.set("v", "<leader>ai", function()
			vscode.action("aipopup.action.modal.generate")
		end, { desc = "Cursor Inline Prompt" })
		vim.keymap.set("v", "<leader>ae", function()
			vscode.action("aichat.insertselectionintochat")
		end, { desc = "Cursor Add Selection To Chat" })
	else
		vim.keymap.set("n", "<leader>;i", function()
			vscode.action("workbench.panel.chatEditing")
