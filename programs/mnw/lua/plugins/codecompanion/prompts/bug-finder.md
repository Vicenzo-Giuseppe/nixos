...
## name: Bug Finder interaction: chat description: Find potential bugs from the provided diff changes opts: is_default: false alias: bugs is_slash_cmd: true auto_submit: true
