...
## name: PullRequest interaction: chat description: Generate a Pull Request message description opts: is_default: false alias: pr is_slash_cmd: true auto_submit: true
