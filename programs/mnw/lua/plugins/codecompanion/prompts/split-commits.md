...
## name: Split Commits interaction: chat description: agent mode with explicit set of tools opts: is_default: false alias: commits is_slash_cmd: true auto_submit: false
