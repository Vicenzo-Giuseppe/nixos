...
## name: Add Documentation interaction: inline description: Add documentation to the selected code opts: is_default: false modes: - v alias: doc is_slash_cmd: true auto_submit: true user_prompt: false stop_context_insertion: true
...
1. **Review the Documentation**: Ensure the documentation:
