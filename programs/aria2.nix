{
  ...
  # Some Cloudflare-issued certificates currently rely on this intermediate,
  # but OpenSSL-based clients such as curl/aria2 do not fetch it via AIA.
  sslComTlsTransitEccR2 = pkgs.fetchurl {
    url = "http://cert.ssl.com/SSL.com-TLS-T-ECC-R2.pem";
    hash = "sha256-ZyHCplilsA5hWrF0Dl0nIh4K29woi4vopu54upfzMWY=";
  };
  ...
  trackerList = [
    ...
    "udp://tracker.nartlof.com.br:6969/announce"
    ...
    "udp://tracker1.520.jp:6969/announce"
  ...
  aria2Settings = {
    ...
    bt-tracker = lib.concatStringsSep "," trackerList;
...
in {
  nixos = lib.mkIf enabled {
    security.pki.certificateFiles = [sslComTlsTransitEccR2];
    ...
    systemd.tmpfiles.rules = [
      "d ${downloadDir} 0775 aria2 aria2 -"
    ];
  };
